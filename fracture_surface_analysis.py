...
sliced_contour_xy = analysis.slicer_xy_plane(z_value=0.85,
                                             side=side,
                                             limits_x=[20,160],
...
plotter.plot_xy_contour(contour_to_plot='Contour', limits_x_plot=[10,170], limits_angle_plot=[-70,70])
...
x_range = range_generator(side = side,
                          limits=[20,160],
                          interval=40)
...
for element in x_range:
    ...
    shearlip_analysis = analysis.shearlip_condition(segment_percentage_min=5,
                                                    segment_percentage_max=40,
                                                    corr_coeff_min=0.75,
                                                    angle_difference_central_min=15)

    modi_analysis = analysis.modi_condition(undefined_percentage_max=50,
